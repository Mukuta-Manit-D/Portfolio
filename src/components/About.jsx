    ...
    <>
        ...
        >
          ...
          <div className='text-profile font-bold text-[20px] mt-5 '>
            <ul className="justify-center">
              <li><span className=" text-primary font-black">Name:</span> &nbsp;Mukuta Manit D</li>
              <li><span className=" text-primary font-black">Date of Birth:</span> &nbsp;27 May 2004</li>
              <li><span className=" text-primary font-black">Place of Birth:</span> &nbsp;Mysuru</li>
              <li><span className=" text-primary font-black">Ph:</span> &nbsp;6361854179</li>
              <li><span className=" text-primary font-black">Email:</span> &nbsp;mukutamanitd6@gmail.com</li>
              <br />
              <li><span className=" text-primary font-black">Nationality:</span> &nbsp;Indian</li>
              <li><span className=" text-primary font-black">Languages:</span> &nbsp;English, Kannada</li>
              <li><span className=" text-primary font-black">Hobbies:</span> &nbsp;Chess, Listening to Music, Reading Books</li>
              <li><span className=" text-primary font-black">Areas of Interest:</span> &nbsp;AIML, Bootstrap and Tailwind, OS and Kernals, Share Markets</li>
            </ul>
          </div>
        </motion.div>
      ...
      >
        ...
        <p className='mt-4 text-secondary sm:text-[20px] leading-[30px] text-[16px] lg:[22px]'>
          ...
          In addition to my programming skills, I am also an aspiring AI/ML Engineer. I am intrigued by the challenge of designing and implementing AI/ML models, algorithms, and architectures to solve complex problems, and I am continuously honing my skills in this area.<br />
